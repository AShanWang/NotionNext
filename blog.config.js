...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jyjc.cloudns.org', // 网站地址
  ...
  // ,wechat,qq,weibo,email,facebook,twitter,telegram,messenger,line,reddit,whatsapp,linkedin
  ...
  COMMENT_TWIKOO_CDN_URL:
    ...
    'https://cdn.staticfile.org/twikoo/1.6.19/twikoo.min.js', // twikoo客户端cdn
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || 'https://img.gugu.ovh/i/2024/04/13/221557.webp', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
  TITLE: process.env.NEXT_PUBLIC_TITLE || '简易教程', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '用心做好每一期教程！', // 站点描述，被notion中的页面描述覆盖
